...
export default function Navbar({ session, userDb }: { session?: any, userDb?: any }) {
  ...
  return (
    <header className="bg-white border-b border-slate-200 h-16 md:h-20 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-bold text-slate-800 hidden md:block">Dashboard</h1>
        <div className="md:hidden font-black text-lg tracking-tight flex items-center gap-1.5">
